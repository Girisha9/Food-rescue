...
$people=$quantity*2;
$sql="INSERT INTO `food`(`address`, `city`,`contact_no.`, `quantity`, `estimated_serves`) VALUES ('$address','$city','$contact','$quantity','$people')";
$result=mysqli_query($conn,$sql);
header("location: http://localhost/food-rescue/vol_appointment.php");
}
?>
<head>
...
<body>
  <div class="main">
    <p class="sign" align="center">please fill this form</p>
    <form class="form1" method="post">
      <input class="un " name="address" type="text" align="center" placeholder="Address">
      <input class="pass" name="city" type="text" align="center" placeholder="city">
      ...
      <button type="submit" class="submit" align="center">Submit</a>
    </form>
