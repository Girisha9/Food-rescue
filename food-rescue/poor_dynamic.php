...
<table>
        ...
        $sql_4="UPDATE vol_allotment set volunteer_name='$_SESSION[name]' where address='$address'";
...
<div style="  background: linear-gradient(90deg, #0ccda3 10%, #C1FCD3 100%) ; padding-top:10px; margin-top:0" >
		...
		<div >
		<br><br> <br>
        <form method="post" action="./poor_updation&org_removal.php" style="margin-left: 31%; " >
      <input type="submit" value="Select  address of population to be supplied" style="width:570px; font-weight:bold; font-size: x-large ;border-radius:15px;margin-top:5px; background-color:#ff9b; font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; color:darkred">
      <br><br>
    <div class="dropdown" style="width:150px; margin-left:180px">
      <select name="address2" id="address2" style="border-radius:20px; font-weight:bold; color:brown">
      <?php
