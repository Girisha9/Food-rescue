...
<br>
    ...
    <div class="dropdown" style="width:10%; margin-left:45%">
    <br> 
      <select name="city" id="city" style="border-radius:15px; color:brown; font-weight: bold; font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">
      <?php
    include 'C:\xampp\htdocs\food-rescue\db_connect.php';
    session_start();
    $sql="select * from survey";
              ...
              <div class="swiper-wrapper" style="transform: translate3d(-570px, 0px, 0px); transition-duration: 0ms;">
                <div class="swiper-slide swiper-slide-prev" style="width: 570px;">
                  <div class="team-slide">
                    <div class="team-photo equalheight" style="height: 275px;"> <img alt="image" src=""> </div>
                    <div class="team-text">
                      <h3>Mr. Pratham Bhatia</h3>
                      <span></span>
                      <p class="top20 bottom20">bhatia op</p>
                    </div>
                  </div>
                </div>
                <div class="swiper-slide swiper-slide-active" style="width: 570px;">
                  <div class="team-slide">
                    <div class="team-photo equalheight" style="height: 275px;"> <img alt="image" src="./images/bhatia.jpeg" style="width:240px"> </div>
                    <div class="team-text">
                ...
                <div class="swiper-slide swiper-slide-next" style="width: 570px;">
                  <div class="team-slide">
                    ...
                    <div class="team-text">
                      ...
                      <p class="top20 bottom20">Rohan Kumar Behra is IIITIAN with Enrollment of IIT2021145 </p> 
                    </div>
                  </div>
